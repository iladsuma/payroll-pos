...
<div class="sidebar">
    ...
    <select id="cabangFilter" name="cabang" onchange="this.form.submit()">
        ...
        <button class="add" onclick="window.location.href='{{ route('karyawan.create') }}'">Tambah Data</button>
        <table>
            <thead>
                <tr>
                    <th>Nama</th>
        ...
        <button class="add" onclick="window.location.href='#'">Tambah Data</button>
    </div>
</body>
</html>
